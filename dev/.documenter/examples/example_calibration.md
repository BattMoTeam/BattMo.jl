...
Calibration: Calibration finished in 129.806106704 seconds.
[1mNegativeElectrode: Active calibration parameters[0m
┌──────────────────────────────────────────────────┬───────────────┬────────────────────┬─────────────────┬──────────┐
...
├───────────────┼────────┼────────────┼──────────┤
│[1m Properties    [0m│ 0.3398 │    16.48 % │  36.0160 │
│[1m Equations     [0m│ 0.1670 │    10.70 % │  23.3787 │
│[1m Assembly      [0m│ 0.0741 │     4.74 % │  10.3713 │
│[1m Linear solve  [0m│ 0.6803 │    32.99 % │  72.1149 │
│[1m Linear setup  [0m│ 0.0000 │     0.00 % │   0.0000 │
│[1m Precond apply [0m│ 0.0000 │     0.00 % │   0.0000 │
│[1m Update        [0m│ 0.0571 │     2.77 % │   6.0484 │
│[1m Convergence   [0m│ 0.0716 │     4.58 % │  10.0171 │
│[1m Input/Output  [0m│ 0.0275 │     0.44 % │   0.9610 │
│[1m Other         [0m│ 0.5631 │    27.30 % │  59.6836 │
├───────────────┼────────┼────────────┼──────────┤
│[1m Total         [0m│ 2.0622 │   100.00 % │ 218.5910 │
╰───────────────┴────────┴────────────┴──────────╯
✔️ Validation of CellParameters passed: No issues found.
──────────────────────────────────────────────────
✔️ Validation of CyclingProtocol passed: No issues found.
...
│[1m               [0m│[90m     ms [0m│[90m Percentage [0m│[90m       ms [0m│
├───────────────┼────────┼────────────┼──────────┤
│[1m Properties    [0m│ 0.3007 │    30.04 % │  36.6842 │
│[1m Equations     [0m│ 0.1512 │    19.07 % │  23.2912 │
│[1m Assembly      [0m│ 0.0622 │     7.85 % │   9.5831 │
│[1m Linear solve  [0m│ 0.1641 │    16.39 % │  20.0157 │
│[1m Linear setup  [0m│ 0.0000 │     0.00 % │   0.0000 │
│[1m Precond apply [0m│ 0.0000 │     0.00 % │   0.0000 │
│[1m Update        [0m│ 0.0501 │     5.01 % │   6.1158 │
│[1m Convergence   [0m│ 0.0642 │     8.09 % │   9.8835 │
│[1m Input/Output  [0m│ 0.0248 │     0.67 % │   0.8187 │
│[1m Other         [0m│ 0.1289 │    12.88 % │  15.7303 │
├───────────────┼────────┼────────────┼──────────┤
│[1m Total         [0m│ 1.0010 │   100.00 % │ 122.1224 │
╰───────────────┴────────┴────────────┴──────────╯
[1mNegativeElectrode: Active calibration parameters[0m
┌─────────────────────────────────────┬───────────────┬───────────────────┐
│[1m                                Name [0m│[1m Initial value [0m│[1m            Bounds [0m│
...
Calibration: Calibration finished in 46.153265271 seconds.
[1mNegativeElectrode: Active calibration parameters[0m
┌─────────────────────────────────────┬───────────────┬───────────────────┬─────────────────┬─────────┐
│[1m                                Name [0m│[1m Initial value [0m│[1m            Bounds [0m│[1m Optimized value [0m│[1m  Change [0m│
├─────────────────────────────────────┼───────────────┼───────────────────┼─────────────────┼─────────┤
