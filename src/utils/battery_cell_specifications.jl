...
function computeCellSpecifications(inputparams::ParameterSet)
...
function computeEnergyEfficiency(inputparams::ParameterSet)
    ...
    inputparams2 = ParameterSet(jsondict)
...
function computeDischargeEnergy(inputparams::ParameterSet)
