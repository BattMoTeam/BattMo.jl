...
function safe_div(x, y; th = 1.0e-8)
...
function reaction_rate_coefficient(
	R0,
	c_e,
	c_a,
	activematerial,
...
function reaction_rate_coefficient_chayambuka(
	R0,
	c_e,
	c_a,
	activematerial,
...
function reaction_rate_chayambuka(
	eta,
	c_a_surf,
	R0,
	T,
