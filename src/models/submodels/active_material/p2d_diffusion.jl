...
struct SolidDiffusionBoundaryCondition <: JutulEquation end
Jutul.local_discretization(::SolidDiffusionBoundaryCondition, i) = nothing
...
struct SolidMassConservation <: JutulEquation end

Jutul.local_discretization(::SolidMassConservation, i) = nothing
...
# Jutul.number_of_equations_per_entity(model::ActiveMaterialModel, ::SolidDiffusionBoundaryCondition) = 1

function Jutul.number_of_equations_per_entity(model::ActiveMaterialModel, ::SolidMassConservation)
...
function Jutul.update_equation_in_entity!(eq_buf              ,
       ...
       state               ,
       state0              ,
       eq::SolidDiffusionBoundaryCondition,
       model               ,
       dt                  ,
       ldisc = Nothing)
