...
@jutul_secondary function update_diffusivity!(D, D_def::Diffusivity, model::ElectrolyteModel, ElectrolyteConcentration, Temperature, VolumeFraction, BruggemanCoefficient, ix)
