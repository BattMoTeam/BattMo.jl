...
function apply_bc_to_equation!(storage, parameters, model, eq::SolidMassConservation, eq_s)
    # do nothing
end

function apply_bc_to_equation!(storage, parameters, model, eq::SolidDiffusionBoundaryCondition, eq_s)
    # do nothing    
end
