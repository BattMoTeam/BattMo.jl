...
function get_parameter_meta_data()
    meta_data = Dict(
        ...
        "UseSEIModel" => Dict("type" => Bool),
        "SEIModel" => Dict("type" => String, "options" => ["Bolay"]),
        ...
        "OpenCircuitVoltage" => Dict(
            "context_type" => ["OpenCircuitVoltage", "Expression"],
        ...
        "StartWithCharge" =>
            Dict("description" => "Starting charge state of the system", "type" => Bool),
