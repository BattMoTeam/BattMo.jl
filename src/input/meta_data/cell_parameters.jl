...
function get_cell_parameters_meta_data()
    meta_data = Dict(
        ...
        "TabPositionFraction" => Dict(
            "type" => Real,
            "unit" => "-",
            "unit_name" => "dimensionless",
            "unit_iri" => "https://w3id.org/emmo#Dimensionless",
            "context_type" => "TabPositionFraction",
            "description" => "Location of the tab along the direction of the width. The position is given by a fraction which determines the position of the tab along the x-axis of the current collector, where 0 corresponds to the inner side and 1 to the outer side.",
        ),
        "InnerRadius" => Dict(
            "type" => Real,
            "min_value" => 0.001,
        ...
        "NumberOfLayersInParallel" => Dict(
            ...
            "unit_name" => "dimensionless",
            "unit_iri" => "https://w3id.org/emmo#Dimensionless",
            "context_type" => "NumberOfLayersInParallel",
            "context_type_iri" => "https://emmo-repo.github.io/emmo.html#EMMO_41efdf5d_0c9c_4ea0_bb65_f8236e663be5",
            "description" => "Number of electrode pairs in parallel in a cell.",
        ),
        "DoubleCoatedElectrodes" => Dict(
            "type" => Bool,
            "unit" => "-",
            "unit_name" => "dimensionless",
            "unit_iri" => "https://w3id.org/emmo#Dimensionless",
            "context_type" => "DoubleCoatedElectrodes",
            "context_type_iri" => "https://emmo-repo.github.io/domain-electrochemistry/electrochemistry.html#electrochemistry_56f85b19_1384_4e88_b130_cb8e7984db83",
            "description" => "Whether the electrodes are double-coated.",
        ),
        "Height" => Dict(
            "type" => Real,
            "min_value" => 0.01,
        ...
        "TabsOnSameSide" => Dict(
            ...
            "unit_name" => "dimensionless",
            "unit_iri" => "https://w3id.org/emmo#Dimensionless",
            "description" => "Whether the tabs are on the same side of the electrode.",
        ),
        "TabWidth" => Dict(
            "type" => Real,
            "min_value" => 0.0005,
        ...
        "ReactionRateConstant" => Dict(
            ...
            "max_value" => 1.0e-2,
            "min_value" => 1.0e-14,
            "description" => "Proportionality constant quantifying the rate and direction of a chemical reaction by relating it with the concentration of reactants. Enters the Butler-Volmer exchange current density as j0 = R0 * n * F * sqrt(c_e * c_s * (cmax - c_s)) (see `reaction_rate_coefficient` in src/models/battery_cross_terms.jl), which requires R0 in the classic Newman/Doyle k0 convention, m^2.5*mol^-0.5*s^-1 -- NOT mol·m⁻²·s⁻¹.",
            "type" => [String, Dict{String, Vector}, Real],
            "unit" => "m^2.5*mol^-0.5*s^-1",
            "unit_name" => "Newman-Doyle reaction rate constant (no standard EMMO term for this composite unit)",
            "unit_iri" => "",
        ),
        "StoichiometricCoefficientAtSOC100" => Dict(
            "context_type" => "StoichiometricNumberOfSubstance",
        ...
        "StoichiometricCoefficientAtSOC0" => Dict(
            "context_type" => "StoichiometricNumberOfSubstance",
        ...
        "ActivationEnergyOfDiffusion" => Dict(
            "context_type" => "ActivationEnergy",
            "context_type_iri" => "https://w3id.org/emmo/domain/electrochemistry#electrochemistry_d7f8cab9_b035_4ecd_be63_292672572526",
            "max_value" => 1.0e6,
            "min_value" => 1.0e3,
        ...
        "OpenCircuitPotential" => Dict(
            "context_type" => ["OpenCircuitPotential", "Expression"],
        ...
        "HeatTransferCoefficient" => Dict(
            "context_type" => "CoefficientOfHeatTransfer",
