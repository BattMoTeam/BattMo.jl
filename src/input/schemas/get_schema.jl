export get_schema_cell_parameters,
    get_schema_cycling_protocol, get_schema_simulation_settings, get_schema_model_settings
        ...
        push!(
            ...
            Dict(
                ...
                "properties" => Dict(
                    "type" => Dict("type" => "string", "enum" => ["function"]),
                    "data_x" =>
                        Dict("type" => "array", "items" => Dict("type" => "number")),
                    "data_y" =>
                        Dict("type" => "array", "items" => Dict("type" => "number")),
                    "argumentlist" =>
                        Dict("type" => "array", "items" => Dict("type" => "string")),
...
function get_schema_cell_parameters(model_settings::ModelSettings)
    ...
    schema = Dict(
        ...
        "properties" => Dict(
            ...
            "Cell" => Dict(
                ...
                "properties" => Dict(
                    ...
                    "DeviceSurfaceArea" =>
                        create_property(parameter_meta, "DeviceSurfaceArea"),
                    "DubbelCoatedElectrodes" => create_property(
                        parameter_meta, "DubbelCoatedElectrodes"
                    ),
                    "NominalVoltage" =>
                        create_property(parameter_meta, "NominalVoltage"),
                    "NominalCapacity" =>
                        create_property(parameter_meta, "NominalCapacity"),
                    "HeatTransferCoefficient" => create_property(
                        parameter_meta, "HeatTransferCoefficient"
                    ),
                    "InnerCellRadius" =>
                        create_property(parameter_meta, "InnerCellRadius"),
                    "ElectrodeWidth" =>
                        create_property(parameter_meta, "ElectrodeWidth"),
                    "ElectrodeLength" =>
                        create_property(parameter_meta, "ElectrodeLength"),
                    "ElectrodeGeometricSurfaceArea" => create_property(
                        parameter_meta, "ElectrodeGeometricSurfaceArea"
                    ),
                ),
                "required" => ["Case"],
            ),
            "NegativeElectrode" => Dict(
                ...
                "properties" => Dict(
                    "ElectrodeCoating" => Dict(
                        "type" => "object",
                        "properties" => Dict(
                            "BruggemanCoefficient" => create_property(
                                parameter_meta,
                                "BruggemanCoefficient",
                            ),
                            "EffectiveDensity" => create_property(
                                parameter_meta, "EffectiveDensity"
                            ),
                    ...
                    "ActiveMaterial" => Dict(
                        "type" => "object",
                        "properties" => Dict(
                            "MassFraction" => create_property(
                                parameter_meta, "MassFraction"
                            ),
                            "Density" => create_property(parameter_meta, "Density"),
                            "VolumetricSurfaceArea" => create_property(
                                parameter_meta,
                                "VolumetricSurfaceArea",
                            ),
                            "ElectronicConductivity" =>
                                create_property(parameter_meta, "ElectronicConductivity"),
                            "SpecificHeatCapacity" => create_property(
                                parameter_meta,
                                "SpecificHeatCapacity",
                            ),
                            "ThermalConductivity" => create_property(
                                parameter_meta,
                                "ThermalConductivity",
                            ),
                            "DiffusionCoefficient" => create_property(
                                parameter_meta,
                                "DiffusionCoefficient",
                            ),
                            "ParticleRadius" => create_property(
                                parameter_meta, "ParticleRadius"
                            ),
                            "MaximumConcentration" => create_property(
                                parameter_meta,
                            ...
                            "OpenCircuitVoltage" => create_property(
                                parameter_meta, "OpenCircuitVoltage"
                            ),
                            "NumberOfElectronsTransfered" =>
                                create_property(
                                    parameter_meta,
                                    "NumberOfElectronsTransfered",
                                ),
                            ...
                            "ReactionRateConstant" => create_property(
                                parameter_meta,
                    ...
                    "Interphase" => Dict(
                        ...
                        "properties" => Dict(
                            ...
                            "IonicConductivity" => create_property(
                                parameter_meta, "IonicConductivity"
                            ),
                            ...
                            "IntersticialConcentration" =>
                                create_property(
                                    parameter_meta,
                                    "IntersticialConcentration",
                                ),
                            "InitialThickness" => create_property(
                                parameter_meta, "InitialThickness"
                            ),
                        ),
                        "required" => [
                            "MolarVolume",
            ...
            "Separator" => Dict(
                ...
                "properties" => Dict(
                    ...
                    "Density" => create_property(parameter_meta, "Density"),
                    "BruggemanCoefficient" =>
                        create_property(parameter_meta, "BruggemanCoefficient"),
                    "Thickness" => create_property(parameter_meta, "Thickness"),
                    "SpecificHeatCapacity" =>
                        create_property(parameter_meta, "SpecificHeatCapacity"),
                    "ThermalConductivity" =>
                        create_property(parameter_meta, "ThermalConductivity"),
                ),
                "required" =>
                    ["Porosity", "Density", "BruggemanCoefficient", "Thickness"],
            ),
            "Electrolyte" => Dict(
                "type" => "object",
                "properties" => Dict(
                    ...
                    "IonicConductivity" =>
                        create_property(parameter_meta, "IonicConductivity"),
                    "DiffusionCoefficient" =>
                        create_property(parameter_meta, "DiffusionCoefficient"),
                    "ChargeNumber" => create_property(parameter_meta, "ChargeNumber"),
                    "TransferenceNumber" =>
                        create_property(parameter_meta, "TransferenceNumber"),
                ),
                "required" => [
                    "Concentration",
                    "Density",
        ...
        "required" =>
            ["Cell", "NegativeElectrode", "PositiveElectrode", "Separator", "Electrolyte"],
    )
    ...
    return Dict(
        ...
        "properties" => Dict(
            ...
            "InitialStateOfCharge" =>
                create_property(parameter_meta, "InitialStateOfCharge"),
            "TotalNumberOfCycles" =>
                create_property(parameter_meta, "TotalNumberOfCycles"),
            ...
            "CurrentChangeLimit" =>
                create_property(parameter_meta, "CurrentChangeLimit"),
            "VoltageChangeLimit" =>
                create_property(parameter_meta, "VoltageChangeLimit"),
            "AmbientKelvinTemperature" =>
                create_property(parameter_meta, "AmbientKelvinTemperature"),
            "InitialKelvinTemperature" =>
                create_property(parameter_meta, "InitialKelvinTemperature"),
        ),
        "required" => ["Protocol"],
        "allOf" => [
            Dict(
                "if" =>
                    Dict("properties" => Dict("Protocol" => Dict("const" => "CCCV"))),
                "then" => Dict(
                    "required" => [
                        "InitialStateOfCharge",
                        "TotalNumberOfCycles",
            ...
            Dict(
                "if" => Dict(
                    "properties" => Dict("Protocol" => Dict("const" => "CCDischarge")),
                ),
                "then" => Dict(
                    "required" => [
                        "InitialStateOfCharge",
    ...
    schema = Dict(
        ...
        "properties" => Dict(
            "GridPoints" => Dict(
                "type" => "object",
                "properties" => Dict(
                    "ElectrodeWidth" => create_property(
                        parameter_meta, "GridPointsElectrodeWidth"
                    ),
                    "ElectrodeLength" => create_property(
                        parameter_meta, "GridPointsElectrodeLength"
                    ),
                    "PositiveElectrodeCoating" => create_property(
                        parameter_meta, "GridPointsPositiveElectrodeCoating"
                    ),
                    "PositiveElectrodeActiveMaterial" => create_property(
                        parameter_meta,
                        "GridPointsPositiveElectrodeActiveMaterial",
                    ),
                    "PositiveElectrodeCurrentCollector" => create_property(
                        parameter_meta,
                        "GridPointsPositiveElectrodeCurrentCollector",
                    ),
                    "PositiveElectrodeCurrentCollectorTabWidth" =>
                        create_property(
                            parameter_meta,
                            "GridPointsPositiveElectrodeCurrentCollectorTabWidth",
                        ),
                    "PositiveElectrodeCurrentCollectorTabLength" =>
                        create_property(
                            parameter_meta,
                            "GridPointsPositiveElectrodeCurrentCollectorTabLength",
                        ),
                    "NegativeElectrodeCoating" => create_property(
                        parameter_meta, "GridPointsNegativeElectrodeCoating"
                    ),
                    "NegativeElectrodeActiveMaterial" => create_property(
                        parameter_meta,
                        "GridPointsNegativeElectrodeActiveMaterial",
                    ),
                    "NegativeElectrodeCurrentCollector" => create_property(
                        parameter_meta,
                        "GridPointsNegativeElectrodeCurrentCollector",
                    ),
                    "NegativeElectrodeCurrentCollectorTabWidth" =>
                        create_property(
                            parameter_meta,
                            "GridPointsNegativeElectrodeCurrentCollectorTabWidth",
                        ),
                    "NegativeElectrodeCurrentCollectorTabLength" =>
                        create_property(
                            parameter_meta,
                            "GridPointsNegativeElectrodeCurrentCollectorTabLength",
                        ),
                    "Separator" =>
                        create_property(parameter_meta, "GridPointsSeparator"),
                ),
                "required" => [
    ...
    return Dict(
        ...
        "properties" => Dict(
            ...
            "UseCurrentCollectors" =>
                create_property(parameter_meta, "UseCurrentCollectors"),
        ...
        "allOf" => [
            ...
            Dict(
                ...
                "then" => Dict("not" => Dict("required" => ["SEIModel"])),
            ),
            ...
            Dict(
                ...
                "then" => Dict(
                    "properties" =>
                        Dict("UseCurrentCollectors" => Dict("const" => false)),
                ),
            ),
        ],
    )
