    ...
    schema = Dict(
        ...
        "properties" => Dict(
            ...
            "Electrolyte" => Dict(
                ...
                "required" => ["Concentration", "Density", "DiffusionCoefficient", "IonicConductivity", "BruggemanCoefficient", "ChargeNumber", "TransferenceNumber"],
            ),
        ),
    ...
    schema = Dict(
        ...
        "allOf" => [
            Dict(
                ...
                "then" => Dict(
                    "properties" => Dict("LinearSolver" => Dict("required" => ["MaxSize"])),
                ),
            ),
            Dict(
                "if" => Dict(
                ...
                "then" => Dict(
                    "properties" => Dict("LinearSolver" => Dict("required" => ["Verbosity", "MaxLinearIterations", "LinearTolerance"])),
                ),
            ),
            Dict(
                "if" => Dict(
