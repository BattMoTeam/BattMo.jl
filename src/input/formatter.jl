...
function convert_parameter_sets_to_battmo_input(
    ...
    battmo_input = Dict(
        ...
        "include_current_collectors" =>
            get_key_value(model_settings, "UseCurrentCollectors"),
        "Control" => Dict(
            ...
            "lowerCutoffVoltage" =>
                get_key_value(cycling_protocol, "LowerVoltageLimit"),
            "upperCutoffVoltage" =>
                get_key_value(cycling_protocol, "UpperVoltageLimit"),
        ...
        "NegativeElectrode" => Dict(
            ...
            "Coating" => Dict(
                ...
                "bruggemanCoefficient" =>
                    get_key_value(ne_coating, "BruggemanCoefficient"),
                "ActiveMaterial" => Dict(
                    "massFraction" => get_key_value(ne_am, "MassFraction"),
                    "density" => get_key_value(ne_am, "Density"),
                    "specificHeatCapacity" =>
                        get_key_value(ne_am, "SpecificHeatCapacity"),
                    "thermalConductivity" =>
                        get_key_value(ne_am, "ThermalConductivity"),
                    "electronicConductivity" =>
                        get_key_value(ne_am, "ElectronicConductivity"),
                    "SEImodel" => get_key_value(model_settings, "SEIModel"),
                    "Interface" => Dict(
                        "saturationConcentration" =>
                            get_key_value(ne_am, "MaximumConcentration"),
                        "volumetricSurfaceArea" =>
                            get_key_value(ne_am, "VolumetricSurfaceArea"),
                        "numberOfElectronsTransferred" => get_key_value(
                            ne_am, "NumberOfElectronsTransfered"
                        ),
                        "activationEnergyOfReaction" => get_key_value(
                            ne_am, "ActivationEnergyOfReaction"
                        ),
                        "reactionRateConstant" =>
                            get_key_value(ne_am, "ReactionRateConstant"),
                        "guestStoichiometry100" => get_key_value(
                            ne_am, "StoichiometricCoefficientAtSOC100"
                        ),
                        "guestStoichiometry0" => get_key_value(
                            ne_am, "StoichiometricCoefficientAtSOC0"
                        ),
                        "chargeTransferCoefficient" => get_key_value(
                            ne_am, "ChargeTransferCoefficient"
                        ),
                        "openCircuitPotential" =>
                            get_key_value(ne_am, "OpenCircuitVoltage"),
                        "SEImolarVolume" => get_key_value(ne_interphase, "MolarVolume"),
                        "SEIionicConductivity" => get_key_value(
                            ne_interphase, "IonicConductivity"
                        ),
                        "SEIelectronicDiffusionCoefficient" =>
                            get_key_value(ne_interphase, "ElectronicDiffusionCoefficient"),
                        "SEIstoichiometricCoefficient" => get_key_value(
                            ne_interphase, "StoichiometricCoefficient"
                        ),
                        "SEIintersticialConcentration" => get_key_value(
                            ne_interphase, "IntersticialConcentration"
                        ),
                        "SEIlengthInitial" => get_key_value(
                            ne_interphase, "InitialThickness"
                        ),
                        "SEIvoltageDropRef" => get_key_value(
                            ne_interphase, "InitialPotentialDrop"
                        ),
                    ...
                    "SolidDiffusion" => Dict(
                        "activationEnergyOfDiffusion" => get_key_value(
                            ne_am, "ActivationEnergyOfDiffusion"
                        ),
                        "referenceDiffusionCoefficient" =>
                            get_key_value(ne_am, "DiffusionCoefficient"),
                ...
                "Binder" => Dict(
                    ...
                    "electronicConductivity" =>
                        get_key_value(ne_b, "ElectronicConductivity"),
                    "specificHeatCapacity" =>
                        get_key_value(ne_b, "SpecificHeatCapacity"),
                ...
                "ConductingAdditive" => Dict(
                    ...
                    "electronicConductivity" =>
                        get_key_value(ne_ca, "ElectronicConductivity"),
                    "specificHeatCapacity" =>
                        get_key_value(ne_ca, "SpecificHeatCapacity"),
                    "thermalConductivity" =>
                        get_key_value(ne_ca, "ThermalConductivity"),
                ),
            ...
            "CurrentCollector" => Dict(
                "electronicConductivity" =>
                    get_key_value(ne_cc, "ElectronicConductivity"),
        ...
        "PositiveElectrode" => Dict(
            ...
            "Coating" => Dict(
                ...
                "bruggemanCoefficient" =>
                    get_key_value(pe_coating, "BruggemanCoefficient"),
                "ActiveMaterial" => Dict(
                    "massFraction" => get_key_value(pe_am, "MassFraction"),
                    "density" => get_key_value(pe_am, "Density"),
                    "specificHeatCapacity" =>
                        get_key_value(pe_am, "SpecificHeatCapacity"),
                    "thermalConductivity" =>
                        get_key_value(pe_am, "ThermalConductivity"),
                    "electronicConductivity" =>
                        get_key_value(pe_am, "ElectronicConductivity"),
                    "Interface" => Dict(
                        "saturationConcentration" =>
                            get_key_value(pe_am, "MaximumConcentration"),
                        "volumetricSurfaceArea" =>
                            get_key_value(pe_am, "VolumetricSurfaceArea"),
                        "numberOfElectronsTransferred" => get_key_value(
                            pe_am, "NumberOfElectronsTransfered"
                        ),
                        "activationEnergyOfReaction" => get_key_value(
                            pe_am, "ActivationEnergyOfReaction"
                        ),
                        "reactionRateConstant" =>
                            get_key_value(pe_am, "ReactionRateConstant"),
                        "guestStoichiometry100" => get_key_value(
                            pe_am, "StoichiometricCoefficientAtSOC100"
                        ),
                        "guestStoichiometry0" => get_key_value(
                            pe_am, "StoichiometricCoefficientAtSOC0"
                        ),
                        "chargeTransferCoefficient" => get_key_value(
                            pe_am, "ChargeTransferCoefficient"
                        ),
                        "openCircuitPotential" =>
                            get_key_value(pe_am, "OpenCircuitVoltage"),
                    ),
                    "diffusionModelType" => "full",
                    "SolidDiffusion" => Dict(
                        "activationEnergyOfDiffusion" => get_key_value(
                            pe_am, "ActivationEnergyOfDiffusion"
                        ),
                        "referenceDiffusionCoefficient" =>
                            get_key_value(pe_am, "DiffusionCoefficient"),
                ...
                "Binder" => Dict(
                    ...
                    "electronicConductivity" =>
                        get_key_value(pe_b, "ElectronicConductivity"),
                    "specificHeatCapacity" =>
                        get_key_value(pe_b, "SpecificHeatCapacity"),
                ...
                "ConductingAdditive" => Dict(
                    ...
                    "electronicConductivity" =>
                        get_key_value(pe_ca, "ElectronicConductivity"),
                    "specificHeatCapacity" =>
                        get_key_value(pe_ca, "SpecificHeatCapacity"),
                    "thermalConductivity" =>
                        get_key_value(pe_ca, "ThermalConductivity"),
                ),
            ...
            "CurrentCollector" => Dict(
                "electronicConductivity" =>
                    get_key_value(pe_cc, "ElectronicConductivity"),
        ...
        "ThermalModel" => Dict(
            "externalHeatTransferCoefficient" =>
                get_key_value(cell, "HeatTransferCoefficient"),
            "externalTemperature" =>
                get_key_value(cycling_protocol, "AmbientKelvinTemperature"),
        ...
        "TimeStepping" => Dict(
            ...
            "timeStepDuration" =>
                get_key_value(simulation_settings, "TimeStepDuration"),
        ),
    )
