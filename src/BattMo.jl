...
include("input/defaults/cell_parameters/function_parameters_HC_NVPF_electrodes.jl")
include("input/defaults/cell_parameters/function_parameters_LP2770120_graphite_LFP_prismatic.jl")
