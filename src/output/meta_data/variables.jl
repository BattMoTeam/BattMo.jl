...
function get_output_variables_meta_data()
    meta_dict = Dict(
        ...
        "NegativeElectrodeActiveMaterialPosition" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nNegativeElectrodeActiveMaterialPosition,)",
            "isdefault" => true,
            "unit" => "m",
            "unit_name" => "emmo:Metre",
            "unit_iri" => "https://w3id.org/emmo#Metre",
            "context_type" => "Position",
            "context_type_iri" => nothing,
            "description" => "Multi-dimensional spatial grid values, representing the position within the negative electrode active material.",
        ),
        "PositiveElectrodeActiveMaterialPosition" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nPositiveElectrodeActiveMaterialPosition,)",
            "isdefault" => true,
            "unit" => "m",
            "unit_name" => "emmo:Metre",
            "unit_iri" => "https://w3id.org/emmo#Metre",
            "context_type" => "Position",
            "context_type_iri" => nothing,
            "description" => "Multi-dimensional spatial grid values, representing the position within the positive electrode active material.",
        ),
        "PositiveElectrodeCurrentCollectorPosition" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nPositiveElectrodeCurrentCollectorPosition,)",
            "isdefault" => true,
            "unit" => "m",
            "unit_name" => "emmo:Metre",
            "unit_iri" => "https://w3id.org/emmo#Metre",
            "context_type" => "Position",
            "context_type_iri" => nothing,
            "description" => "Multi-dimensional spatial grid values, representing the position within the positive electrode current collector.",
        ),
        "NegativeElectrodeCurrentCollectorPosition" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nNegativeElectrodeCurrentCollectorPosition,)",
            "isdefault" => true,
            "unit" => "m",
            "unit_name" => "emmo:Metre",
            "unit_iri" => "https://w3id.org/emmo#Metre",
            "context_type" => "Position",
            "context_type_iri" => nothing,
            "description" => "Multi-dimensional spatial grid values, representing the position within the negative electrode current collector.",
        ),
        "ElectrolytePosition" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nElectrolytePosition,)",
            "isdefault" => true,
            "unit" => "m",
            "unit_name" => "emmo:Metre",
            "unit_iri" => "https://w3id.org/emmo#Metre",
            "context_type" => "Position",
            "context_type_iri" => nothing,
            "description" => "Multi-dimensional spatial grid values, representing the position within the electrolyte.",
        ),
        "SeparatorPosition" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nSeparatorPosition,)",
            "isdefault" => true,
            "unit" => "m",
            "unit_name" => "emmo:Metre",
            "unit_iri" => "https://w3id.org/emmo#Metre",
            "context_type" => "Position",
            "context_type_iri" => nothing,
            "description" => "Multi-dimensional spatial grid values, representing the position within the separator.",
        ),
        ...
        "PositiveElectrodeCurrentCollectorPotential" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nTime, nPosition)",
            "description" => "Potential within the positive electrode current collector.",
            "isdefault" => false,
            "unit" => "V",
            "unit_name" => "emmo:Volt",
            "unit_iri" => "https://w3id.org/emmo#EMMO_5ebd5e01_0ed3_49a2_a30d_cd05cbe72978",
        ...
        "NegativeElectrodeCurrentCollectorPotential" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nTime, nPosition)",
            "description" => "Potential within the negative electrode current collector.",
            "isdefault" => false,
            "unit" => "V",
            "unit_name" => "emmo:Volt",
            "unit_iri" => "https://w3id.org/emmo#EMMO_5ebd5e01_0ed3_49a2_a30d_cd05cbe72978",
        ...
        "NegativeElectrodeCurrentCollectorCharge" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nTime, nPosition)",
            "description" => "Charge stored in the negative electrode current collector.",
            "isdefault" => false,
            "unit" => "C",
            "unit_name" => "emmo:Coulomb",
            "unit_iri" => "https://w3id.org/emmo#EMMO_5ebd5e01_0ed3_49a2_a30d_cd05cbe72978",
        ...
        "PositiveElectrodeCurrentCollectorCharge" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nTime, nPosition)",
            "description" => "Charge stored in the positive electrode current collector.",
            "isdefault" => false,
            "unit" => "C",
            "unit_name" => "emmo:Coulomb",
            "unit_iri" => "https://w3id.org/emmo#EMMO_5ebd5e01_0ed3_49a2_a30d_cd05cbe72978",
        ...
        "NegativeElectrodeInterphaseThickness" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nTime, nPosition)",
        ...
        "NegativeElectrodeInterphaseVoltageDrop" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nTime, nPosition)",
        ...
        "NegativeElectrodeInterphaseNormalizedThickness" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nTime, nPosition)",
        ...
        "NegativeElectrodeInterphaseNormalizedVoltageDrop" => Dict(
            "type" => Vector{Real},
            "case" => "states",
            "shape" => "(nTime, nPosition)",
        ...
        "SEIThickness" => Dict(
            ...
            "case" => "states",
            "shape" => "(nTime, nPosition)",
            "description" => "Compatibility alias for NegativeElectrodeInterphaseThickness.",
            "isdefault" => false,
            "unit" => "m",
            "unit_name" => "emmo:Metre",
            "unit_iri" => "https://w3id.org/emmo#EMMO_5ebd5e01_0ed3_49a2_a30d_cd05cbe72978",
        ...
        "SEIVoltageDrop" => Dict(
            ...
            "case" => "states",
            "shape" => "(nTime, nPosition)",
            "description" => "Compatibility alias for NegativeElectrodeInterphaseVoltageDrop.",
            "isdefault" => false,
            "unit" => "V",
            "unit_name" => "emmo:Volt",
            "unit_iri" => "https://w3id.org/emmo#EMMO_5ebd5e01_0ed3_49a2_a30d_cd05cbe72978",
        ...
        "NormalizedSEIThickness" => Dict(
            ...
            "case" => "states",
            "shape" => "(nTime, nPosition)",
            "description" => "Compatibility alias for NegativeElectrodeInterphaseNormalizedThickness.",
            "isdefault" => false,
            "unit" => "m",
            "unit_name" => "emmo:Metre",
            "unit_iri" => "https://w3id.org/emmo#EMMO_5ebd5e01_0ed3_49a2_a30d_cd05cbe72978",
        ...
        "NormalizedSEIVoltageDrop" => Dict(
            ...
            "case" => "states",
            "shape" => "(nTime, nPosition)",
            "description" => "Compatibility alias for NegativeElectrodeInterphaseNormalizedVoltageDrop.",
            "isdefault" => false,
            "unit" => "V",
            "unit_name" => "emmo:Volt",
            "unit_iri" => "https://w3id.org/emmo#EMMO_5ebd5e01_0ed3_49a2_a30d_cd05cbe72978",
