...
function get_r_coords(output)
	...
	number_of_cells_ne = output[:extra][:simulation_settings]["GridNegativeElectrodeParticle"]
	particle_radius_pe = output[:extra][:cell_parameters]["PositiveElectrode"]["ActiveMaterial"]["ParticleRadius"]
	number_of_cells_pe = output[:extra][:simulation_settings]["GridPositiveElectrodeParticle"]
