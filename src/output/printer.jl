...
function print_output_overview(output::NamedTuple)
	...
	var_map = Dict(
		...
		:NegativeElectrodeActiveMaterialReactionRateConst    => [:NegativeElectrodeActiveMaterial, :ReactionRateConstant],
		:PositiveElectrodeActiveMaterialReactionRateConst    => [:PositiveElectrodeActiveMaterial, :ReactionRateConstant],
