...
function setup_initial_control_policy!(policy::SimpleCVPolicy, inputparams::MatlabBattMoInput, parameters)
...
function setup_initial_control_policy!(policy::CyclingCVPolicy, inputparams::MatlabBattMoInput, parameters)
...
function setup_timesteps(inputparams::MatlabBattMoInput;
...
function setup_coupling_cross_terms!(inputparams::MatlabBattMoInput,
	model::MultiModel,
...
function include_current_collectors(inputparams::MatlabBattMoInput)
...
function setup_submodels(inputparams::MatlabBattMoInput;
...
function setup_battery_parameters(inputparams::MatlabBattMoInput,
	model::MultiModel,
)
...
function setup_initial_state(inputparams::MatlabBattMoInput,
	model::MultiModel,
)
