...
function getindex_I_sorted_linear_new(A::AbstractSparseMatrixCSC{Tv, Ti}, I::AbstractVector, J::AbstractVector) where {Tv, Ti}
...
function getindex_I_sorted_bsearch_I_new(A::AbstractSparseMatrixCSC{Tv, Ti}, I::AbstractVector, J::AbstractVector) where {Tv, Ti}
	require_one_based_indexing(A, I, J)
	nI = length(I)
	nJ = length(J)
