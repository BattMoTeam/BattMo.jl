import{_ as a,c as n,o as i,aA as p}from"./chunks/framework.CyAhY-Vo.js";const e="/BattMo.jl/previews/PR34/assets/wyzltuu.CDk-EQ3g.jpeg",l="/BattMo.jl/previews/PR34/assets/aupmotk.Br2u4DWB.jpeg",g=JSON.parse('{"title":"Initial simulation","description":"","frontmatter":{},"headers":[],"relativePath":"examples/example_optimization.md","filePath":"examples/example_optimization.md","lastUpdated":null}'),t={name:"examples/example_optimization.md"};function h(k,s,r,E,u,o){return i(),n("div",null,s[0]||(s[0]=[p(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> BattMo, Jutul, GLMakie</span></span></code></pre></div><h1 id="Initial-simulation" tabindex="-1">Initial simulation <a class="header-anchor" href="#Initial-simulation" aria-label="Permalink to &quot;Initial simulation {#Initial-simulation}&quot;">​</a></h1><p>Run a simulation witht the initial parameter values</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">name </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;Chen2020_calibrated&quot;</span></span>
...
<span class="line"><span>├───────────────┼────────┼────────────┼────────┤</span></span>
<span class="line"><span>│ Properties    │ 0.0323 │     0.45 % │ 0.0083 │</span></span>
<span class="line"><span>│ Equations     │ 1.2771 │    23.46 % │ 0.4368 │</span></span>
<span class="line"><span>│ Assembly      │ 0.6209 │    11.41 % │ 0.2123 │</span></span>
<span class="line"><span>│ Linear solve  │ 0.3370 │     4.67 % │ 0.0869 │</span></span>
...
<span class="line"><span>│ Update        │ 0.1532 │     2.12 % │ 0.0395 │</span></span>
<span class="line"><span>│ Convergence   │ 0.5217 │     9.58 % │ 0.1784 │</span></span>
<span class="line"><span>│ Input/Output  │ 0.3428 │     1.55 % │ 0.0288 │</span></span>
<span class="line"><span>│ Other         │ 3.3740 │    46.76 % │ 0.8705 │</span></span>
<span class="line"><span>├───────────────┼────────┼────────────┼────────┤</span></span>
<span class="line"><span>│ Total         │ 7.2157 │   100.00 % │ 1.8616 │</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span> Cauchy                time 3.357E-04 seconds.</span></span>
<span class="line"><span> Subspace minimization time 3.967E-04 seconds.</span></span>
<span class="line"><span> Line search           time 2.352E+01 seconds.</span></span>
<span class="line"><span></span></span>
<span class="line"><span> Total User time 2.400E+01 seconds.</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Jutul: Simulating 1 hour, 6 minutes as 84 report steps</span></span>
