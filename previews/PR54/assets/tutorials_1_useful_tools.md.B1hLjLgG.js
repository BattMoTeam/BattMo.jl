...
<span class="line"><span>🔹 Description:		The open-circuit potential of the active material under given concentration and temperature conditions</span></span>
...
<span class="line"><span>ℹ️  Parameter Information</span></span>
<span class="line"><span>================================================================================</span></span>
<span class="line"><span>🔹 Name:         	ModelFramework</span></span>
<span class="line"><span>🔹 Description:		Framework defining the dimensionality of the electrochemical model. Examples: &quot;P2D&quot;, &quot;P4D&quot;.</span></span>
<span class="line"><span>🔹 Type:         	String</span></span>
<span class="line"><span>🔹 Options:      	P2D, P4D Pouch</span></span>
<span class="line"><span>🔹 Documentation:	\x1B]8;;https://battmoteam.github.io/BattMo.jl/dev/manuals/user_guide/pxd_model\x1B\\visit\x1B]8;;\x1B\\</span></span>
<span class="line"><span>🔹 Ontology link:	\x1B]8;;https://w3id.org/emmo/domain/battery#battery_b1921f7b_afac_465a_a275_26f929f7f936\x1B\\visit\x1B]8;;\x1B\\</span></span></code></pre></div><p>This is especially useful when building or editing custom parameter sets.</p><h2 id="Listing-Available-Submodels" tabindex="-1">Listing Available Submodels <a class="header-anchor" href="#Listing-Available-Submodels" aria-label="Permalink to &quot;Listing Available Submodels {#Listing-Available-Submodels}&quot;">​</a></h2><p>BattMo supports a modular submodel architecture. To view all available submodels you can integrate into your simulation, run:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">print_submodels_info</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">()</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>================================================================================</span></span>
<span class="line"><span>ℹ️  Submodels Information</span></span>
<span class="line"><span>================================================================================</span></span>
<span class="line"><span>Parameter                     Options                       Documentation</span></span>
<span class="line"><span>--------------------------------------------------------------------------------</span></span>
<span class="line"><span>CurrentCollectors             Generic                       -</span></span>
<span class="line"><span>SEIModel                      Bolay                         \x1B]8;;https://battmoteam.github.io/BattMo.jl/dev/manuals/user_guide/sei_model\x1B\\visit\x1B]8;;\x1B\\</span></span>
<span class="line"><span>ModelFramework                P2D, P4D Pouch                \x1B]8;;https://battmoteam.github.io/BattMo.jl/dev/manuals/user_guide/pxd_model\x1B\\visit\x1B]8;;\x1B\\</span></span>
<span class="line"><span>RampUp                        Sinusoidal                    \x1B]8;;https://battmoteam.github.io/BattMo.jl/dev/manuals/user_guide/ramp_up\x1B\\visit\x1B]8;;\x1B\\</span></span>
<span class="line"><span>TransportInSolid              FullDiffusion                 -</span></span></code></pre></div><h2 id="Write-a-parameter-set-object-to-a-JSON-file" tabindex="-1">Write a parameter set object to a JSON file <a class="header-anchor" href="#Write-a-parameter-set-object-to-a-JSON-file" aria-label="Permalink to &quot;Write a parameter set object to a JSON file {#Write-a-parameter-set-object-to-a-JSON-file}&quot;">​</a></h2><p>You can use the following function to save your ParameterSet object to a JSON file:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">file_path </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;path_to_json_file/file.json&quot;</span></span>
