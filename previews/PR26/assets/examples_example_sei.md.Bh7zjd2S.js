import{_ as s,c as n,o as e,aA as p}from"./chunks/framework.BFbzQv2c.js";const d=JSON.parse('{"title":"Example with SEI layer","description":"","frontmatter":{},"headers":[],"relativePath":"examples/example_sei.md","filePath":"examples/example_sei.md","lastUpdated":null}'),l={name:"examples/example_sei.md"};function t(i,a,o,r,c,h){return e(),n("div",null,a[0]||(a[0]=[p(`<h1 id="Example-with-SEI-layer" tabindex="-1">Example with SEI layer <a class="header-anchor" href="#Example-with-SEI-layer" aria-label="Permalink to &quot;Example with SEI layer {#Example-with-SEI-layer}&quot;">​</a></h1><h2 id="Preparation-of-the-input" tabindex="-1">Preparation of the input <a class="header-anchor" href="#Preparation-of-the-input" aria-label="Permalink to &quot;Preparation of the input {#Preparation-of-the-input}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Jutul, BattMo, GLMakie</span></span></code></pre></div><p>We use the SEI model presented in [<a href="/BattMo.jl/previews/PR26/extras/refs#bolay2022">1</a>]. We use the json data given in <a href="https://github.com/BattMoTeam/BattMo.jl/blob/main/test/data/jsonfiles/bolay.json#L157" target="_blank" rel="noreferrer">bolay.json</a> which contains the parameters for the SEI layer.</p><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>file_path_cell = string(dirname(pathof(BattMo)), &quot;/../test/data/jsonfiles/cell_parameters/&quot;, &quot;SEI_example.json&quot;)</span></span>
