...
@testset "temperature dependence" begin
    ...
    @test begin
        ...
        @test voltage_10[10] ≈ 4.000031958338107 atol = 1.0e-1
        @test voltage_10[end - 10] ≈ 3.067277996724986 atol = 1.0e-1

        @test length(voltage_45) ≈ 145 atol = 1
        @test voltage_45[10] ≈ 3.9903508529579135 atol = 1.0e-1
        @test voltage_45[end - 10] ≈ 3.0561237870691453 atol = 1.0e-1
