...
"""Read a two-column Chayambuka test data table, which is headerless by default."""
function read_chayambuka_test_data(file_name::AbstractString; header::Bool = false)
...
data_pe_ocp = read_chayambuka_test_data("chayambuka_pe_ocp.csv"; header = true)
data_ne_ocp = read_chayambuka_test_data("chayambuka_ne_ocp.csv")
data_pe_D = read_chayambuka_test_data("chayambuka_pe_D.csv")
data_ne_D = read_chayambuka_test_data("chayambuka_ne_D.csv")
data_pe_k = read_chayambuka_test_data("chayambuka_pe_k.csv")
data_ne_k = read_chayambuka_test_data("chayambuka_ne_k.csv")
data_elyte_cond = read_chayambuka_test_data("chayambuka_elyte_sigma.csv")
data_elyte_diff = read_chayambuka_test_data("chayambuka_elyte_D.csv")
