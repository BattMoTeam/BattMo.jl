function open_circuit_potential_graphite_Xu_2015_test(c, T, refT, cmax)
...
function open_circuit_potential_lfp_Xu_2015_test(c, T, refT, cmax)
...
function electrolyte_conductivity_Xu_2015_test(c::Real, T::Real)
...
function electrolyte_diffusivity_Xu_2015_test(c::Real, T::Real)
