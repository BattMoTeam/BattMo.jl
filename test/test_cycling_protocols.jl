...
@testset "Crate" begin
    ...
    @test begin
        ...
        @test I_1[5] ≈ -5.090421803494574 atol = 1.0e-1
        ...
        @test I_2[5] ≈ I_1[5] * 2 atol = 1.0e-2
        ...
        @test I_1[5] ≈ -5.090421803494574 atol = 1.0e-1
        @test I_1[150] ≈ 5.090421803494574 atol = 1.0e-1
        ...
        @test I_2[5] ≈ I_1[5] * 2 atol = 1.0e-2
        @test I_2[50] ≈ I_1[150] * 2 atol = 1.0e-2
        ...
        @test I_1[5] ≈ -5.090421803494574 atol = 1.0e-1
        @test I_1[550] ≈ 5.090421803494574 atol = 1.0e-1
        ...
        @test I_2[5] ≈ I_1[5] * 2 atol = 1.0e-2
        @test I_2[400] ≈ I_1[550] * 2 atol = 1.0e-2
