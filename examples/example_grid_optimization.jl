...
for (i, x_res) in enumerate(x_res_list)
	...
	simulation_settings["GridNegativeElectrodeCoating"] = x_res
	simulation_settings["GridPositiveElectrodeCoating"] = x_res
	simulation_settings["GridSeparator"] = Int(x_res ÷ 2)
