...
for (i, x_res) in enumerate(x_res_list)
	...
	simulation_settings["GridResolution"]["NegativeElectrodeCoating"] = x_res
	simulation_settings["GridResolution"]["PositiveElectrodeCoating"] = x_res
	simulation_settings["GridResolution"]["Separator"] = Int(x_res ÷ 2)
