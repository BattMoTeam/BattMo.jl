    ...
    if !p2d
        ...
        elseif method == "genneral"
            ...
            for mm in cmodels
                ...
                s_preccond = BattMo.VariablePrecond(s_prec, :C, :mass_conservation, mm)
                push!(varpreconds, deepcopy(s_preccond))
            end
        ...
        elseif method == "genneral"
            ...
            for mm in cmodels
                println(mm)
                s_prec = SolverAsPreconditionerSystem(solver_s)
                s_preccond = BattMo.VariablePrecond(s_prec, :Cp, :mass_conservation, mm)
                push!(varpreconds, deepcopy(s_preccond))
            end
            ...
            #     println(mm)
            #     s_prec = SolverAsPreconditionerSystem(solver_s)
            #     s_preccond = BattMo.VariablePrecond(s_prec,:Cs,:solid_diffusion_bc, mm)
            #     push!(varpreconds, deepcopy(s_preccond))
            # end
